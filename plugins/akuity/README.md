...
| `akuity:delegate` | Delegate work to Akuity agents: talk normally with the Deployment Advisor, hand a degraded app to the On-Call Agent, or ask the Promotion Advisor for a pre-promotion risk verdict; relay every proposed action for human approval and read back what the native agent actually did. |
