...
| | `akuity:delegate` | Delegate work to Akuity agents: talk normally with the Deployment Advisor, hand a degraded app to the On-Call Agent, or ask the Promotion Advisor for a pre-promotion risk verdict, with every proposed action relayed for human approval. |
